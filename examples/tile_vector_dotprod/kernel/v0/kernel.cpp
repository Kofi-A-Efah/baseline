/*
 * This kernel performs vector dotproduct. 
 * 
 * This is the most basic version of single-tile Vector-Vector dotprodition.
...
extern "C" {
        ...
        int  __attribute__ ((noinline)) kernel_vector_dotprod_float(
                ...
                rc = kernel_tile_vector_dotprod(A, B, C, nels);
